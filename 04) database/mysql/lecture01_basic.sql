...
//-- WHERE Name LIKE "%e%";    -> (get all rows with Name e letter in  between )

//-- 2)
//-- SELECT * FROM students WHERE Gender LIKE "_ale"; (Give _ale(Male) Pattern in Gender)

//-- 3)
//-- SELECT * FROM students WHERE NOT Gender = "Male"; (Give NOT Male from  Gender)
